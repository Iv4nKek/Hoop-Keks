...
namespace Code.Core
{
    public class WallColliderCreator : MonoBehaviour
    {
        ...
        //Generate world space point information for position and scale calculations
            ...
            screenSize.x = Vector2.Distance (Camera.main.ScreenToWorldPoint(new Vector3(0,0,-10)),Camera.main.ScreenToWorldPoint(new Vector3(Screen.width, 0,-10))) * 0.5f;
            screenSize.y = Vector2.Distance (Camera.main.ScreenToWorldPoint(new Vector3(0,0,-10)),Camera.main.ScreenToWorldPoint(new Vector3(0, Screen.height-_padding,-10))) * 0.5f;
